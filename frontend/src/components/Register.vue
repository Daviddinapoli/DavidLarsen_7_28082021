    ...
    <div class="col-lg-6 col-md-8 col-sm-12 m-auto">
      ...
      <div class="mb-3">
        ...
        <input
          ...
          type="email"
          class="form-control"
          placeholder="Ex: Jack.nicholson@gmail.com"
          required
          @keyup="resetErrors"
        />
...
// The data from our form is passed into our data service which is communicating with the backnd api
